        ...
        <div className="min-h-screen bg-gray-50">
            ...
            <div className="max-w-6xl mx-auto px-6 mt-8 mb-8">
                <div className="flex items-center gap-4 border-b border-gray-200">
                    {["NOC Guide", "Operational Guideline"].map((tab) => (
                        <button
                            key={tab}
                ...
                {activeTab === "NOC Guide" ? (
                    ...
                    >
                        <div className="bg-white rounded-xl  border border-gray-200 p-12 text-center">
                            ...
                            <h2 className="text-sm font-bold text-gray-600 mb-2">Operational Guidelines</h2>
                            <p className="text-gray-400 text-xs">
                                Detailed operational guidelines and procedures will be available here soon.
                            </p>
                        </div>
                    </motion.div>
                )}
