...
import { Bell, BellRing, PlusCircle, FileText, X, Edit, Trash2, AlertCircle } from "lucide-react";
    ...
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
        ...
        <div className="bg-white rounded-xl border border-gray-100 p-6 hover:border-gray-200 transition-colors">
          ...
          <p className="text-3xl font-semibold text-gray-900">{totalNotifications}</p>
        </div>
        ...
        <div className="bg-white rounded-xl border border-gray-100 p-6 hover:border-gray-200 transition-colors">
          ...
          <p className="text-3xl font-semibold text-gray-900">{newNotifications}</p>
        </div>
          ...
          <table className="w-full">
            <thead>
              <tr className="bg-gray-50 border-b border-gray-100">
                ...
                <th className="px-5 py-3 text-left text-xs font-semibold text-gray-600 uppercase tracking-wider whitespace-nowrap">Description</th>
                <th className="px-5 py-3 text-left text-xs font-semibold text-gray-600 uppercase tracking-wider whitespace-nowrap">Date</th>
                <th className="px-5 py-3 text-left text-xs font-semibold text-gray-600 uppercase tracking-wider whitespace-nowrap">Attachment</th>
              ...
              {filteredNotifications.length === 0 ? (
                <tr>
                  <td colSpan="6" className="px-5 py-12 text-center">
                    ...
                    <p className="text-xs text-gray-400 mt-1">Try adjusting your search or add a new notification</p>
                  </td>
                </tr>
              ) : (
                filteredNotifications.map((item, idx) => (
                  ...
                  >
                    ...
                    <td className="px-5 py-3.5">
                      <p className="text-sm font-medium text-gray-900 truncate max-w-[200px]" title={item.notificationTitle}>
