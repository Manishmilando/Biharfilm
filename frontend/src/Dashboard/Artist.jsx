    ...
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
        ...
        <div className="bg-white rounded-xl border border-gray-100 p-6 hover:border-gray-200 transition-colors">
          ...
          <p className="text-3xl font-semibold text-gray-900">{artists.length}</p>
        </div>
        ...
        <div className="bg-white rounded-xl border border-gray-100 p-6 hover:border-gray-200 transition-colors">
          ...
          <p className="text-3xl font-semibold text-gray-900">{newArtistsCount}</p>
        </div>
      ...
      <div className="bg-white rounded-xl border border-gray-100 overflow-hidden">
        <div className="px-6 py-4 border-b border-gray-100 flex justify-between items-center">
          <h2 className="text-lg font-semibold text-gray-900">Artists Directory</h2>
            ...
            <table className="w-full">
              <thead>
                <tr className="bg-gray-50 border-b border-gray-100">
                  <th className="px-5 py-3 text-left text-xs font-semibold text-gray-600 uppercase tracking-wider">#</th>
                  <th className="px-5 py-3 text-left text-xs font-semibold text-gray-600 uppercase tracking-wider">Artist</th>
                  <th className="px-5 py-3 text-left text-xs font-semibold text-gray-600 uppercase tracking-wider">Role</th>
                  <th className="px-5 py-3 text-left text-xs font-semibold text-gray-600 uppercase tracking-wider">Contact</th>
                ...
                {filteredArtists.length === 0 ? (
                  <tr>
                    <td colSpan="6" className="px-5 py-12 text-center">
                      ...
                      <p className="text-xs text-gray-400 mt-1">Try adjusting your search or add a new artist</p>
                    </td>
                  </tr>
                ) : (
                  filteredArtists.map((artist, idx) => (
                    ...
                    >
                      <td className="px-5 py-3.5 text-xs font-medium text-gray-900">{idx + 1}</td>
                      <td className="px-5 py-3.5">
                        <div className="flex items-center gap-3">
                          ...
                          />
                          <div>
                            <p className="text-sm font-medium text-gray-900">{artist.fullName}</p>
                      ...
                      <td className="px-5 py-3.5 text-xs text-gray-600">{artist.district}</td>
        ...
        <div className="fixed inset-0 bg-black/60 backdrop-blur-sm z-[9999] flex items-center justify-center p-4">
          <div className="bg-white rounded-xl w-full max-w-2xl overflow-hidden shadow-2xl">
            ...
            <div className="px-6 py-4 border-b border-gray-100 flex items-center justify-between">
              <div>
                <h2 className="text-base font-semibold text-gray-900">Artist Profile</h2>
                <p className="text-xs text-gray-500 mt-0.5">Complete artist information</p>
              </div>
              <button
            ...
            <div className="p-6 max-h-[calc(90vh-120px)] overflow-y-auto">
              ...
              <div className="flex items-start gap-4 mb-6">
                ...
                <div className="flex-1">
                  <div className="flex items-start justify-between">
                    <div>
                      <h3 className="text-lg font-semibold text-gray-900">{selectedArtist.fullName}</h3>
                      <p className="text-sm text-[#891737] font-medium">{selectedArtist.role}</p>
                    </div>
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
                  <div className="flex items-center gap-2">
                    ...
                    <div className="min-w-0 flex-1">
                      ...
                      <p className="text-xs text-gray-900 truncate">{selectedArtist.email}</p>
                    </div>
                  </div>
                  <div className="flex items-center gap-2">
                    <div className="w-8 h-8 rounded-lg bg-white border border-gray-100 flex items-center justify-center flex-shrink-0">
                    ...
                    <div>
                      ...
                      <p className="text-xs text-gray-900">{selectedArtist.phoneNumber}</p>
                    </div>
                  </div>
                  <div className="flex items-center gap-2">
                    <div className="w-8 h-8 rounded-lg bg-white border border-gray-100 flex items-center justify-center flex-shrink-0">
                  ...
                  <div className="flex items-center gap-2">
                    ...
                    <div>
                      ...
                      <p className="text-xs text-gray-900">{selectedArtist.district}</p>
                    </div>
                  </div>
                </div>
              </div>
              ...
              {selectedArtist.bestFilm && (
                <div className="bg-gray-50 rounded-lg p-4 mb-4">
                  <div className="flex items-center gap-2 mb-2">
                    ...
                    <h4 className="text-sm font-semibold text-gray-900">Best Film</h4>
                  </div>
                  <p className="text-sm text-gray-600 pl-10">{selectedArtist.bestFilm}</p>
                </div>
              )}
              ...
              {selectedArtist.description && (
                <div className="bg-gray-50 rounded-lg p-4">
                  ...
                  <p className="text-sm text-gray-600 leading-relaxed">{selectedArtist.description}</p>
                </div>
              )}
            </div>
