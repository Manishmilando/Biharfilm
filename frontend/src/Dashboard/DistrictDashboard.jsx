                ...
                <div className="mt-24 space-y-10">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                        <div className="bg-[#fff9db] border border-yellow-300 p-6 rounded-lg shadow-sm hover:shadow-md transition">
                            <h4 className="text-xl font-semibold text-yellow-800">{activityOne}</h4>
                            <p className="text-sm mt-2 text-yellow-700">NOCs that have been forwarded for approval.</p>
                        </div>
                        <div className="bg-[#f3e8ff] border border-purple-300 p-6 rounded-lg shadow-sm hover:shadow-md transition">
                            <h4 className="text-xl font-semibold text-purple-800">{activityTwo}</h4>
                            <p className="text-sm mt-2 text-purple-700">Currently under review by officials.</p>
                        </div>
                    </div>
                    ...
                    <div className="space-y-4">
                        ...
                        <div className="overflow-x-auto bg-white rounded-lg shadow-md border border-gray-200">
                            <table className="w-full min-w-[700px] text-sm text-gray-800">
                                ...
                                <tbody>
                                    {cases.map((item) => (
                                        <tr key={item.ProjectId} className="border-t hover:bg-gray-50">
...
const SidebarItem = ({ icon, label, active }) => (
    <a
        href="#"
        className={`flex items-center gap-3 px-4 py-2 rounded-lg ${active ? 'bg-pink-100 text-[#a92b43]' : 'hover:bg-gray-100 text-gray-700'}`}
    >
