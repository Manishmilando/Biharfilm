...
import { Upload, Calendar, Type, FileText, Image as ImageIcon, Save, Film, Coffee, MessageCircle, Award } from "lucide-react";

const FilmClubAdmin = () => {
    const [activeTab, setActiveTab] = useState("Coffee with Film");
    const [activeFestivalTab, setActiveFestivalTab] = useState("IFFI Film Festival");
                    ...
                    <div>
                        ...
                        <div className="flex items-center justify-center w-full">
                            <label className="flex flex-col items-center justify-center w-full h-64 border-2 border-gray-300 border-dashed rounded-lg cursor-pointer bg-gray-50 hover:bg-gray-100 transition-colors">
                                {coffeeData.image ? (
                                    <img src={coffeeData.image} alt="Preview" className="w-full h-full object-cover rounded-lg" />
                                ) : (
                                ...
                                <input type="file" className="hidden" onChange={(e) => handleImageUpload(e, "Coffee")} accept="image/*" />
                            </label>
                        </div>
                    </div>
                        ...
                        <div className="flex items-center justify-center w-full">
                            <label className="flex flex-col items-center justify-center w-full h-64 border-2 border-gray-300 border-dashed rounded-lg cursor-pointer bg-gray-50 hover:bg-gray-100 transition-colors">
                                {cineSamwadData.image ? (
                                    <img src={cineSamwadData.image} alt="Preview" className="w-full h-full object-cover rounded-lg" />
                                ) : (
                                    <div className="flex flex-col items-center justify-center pt-5 pb-6">
                                        <Upload className="w-8 h-8 mb-4 text-gray-500" />
                                        <p className="mb-2 text-sm text-gray-500"><span className="font-semibold">Click to upload</span> or drag and drop</p>
                                ...
                                <input type="file" className="hidden" onChange={(e) => handleImageUpload(e, "Cine")} accept="image/*" />
                            </label>
                        </div>
                    </div>
                        ...
                        <div>
                            ...
                            <div className="relative">
                                ...
                                <input
                                    ...
                                    onChange={(e) => setCineSamwadData({ ...cineSamwadData, title: e.target.value })}
                                />
                            </div>
                        </div>
                        ...
                        <div>
                            ...
                            <div className="relative">
                                ...
                                <input
                                    ...
                                    onChange={(e) => setCineSamwadData({ ...cineSamwadData, date: e.target.value })}
                                />
                            </div>
                        </div>
                    </div>
                    ...
                    <div>
                        ...
                        <div className="relative">
                            ...
                            <textarea
                                ...
                                onChange={(e) => setCineSamwadData({ ...cineSamwadData, description: e.target.value })}
                            />
                        </div>
                    </div>
        ...
        return (
            <div className="space-y-6 max-w-4xl">
                ...
                <div className="flex space-x-1 bg-gray-100 p-1 rounded-lg w-fit mb-6">
                    {["IFFI Film Festival", "Children Film Festival", "Women Film Festival"].map((tab) => (
                        <button
                            key={tab}
                ...
                <div className="bg-white p-6 rounded-xl border border-gray-100 shadow-sm">
                    ...
                    <div className="space-y-4">
                        {/* Image Upload */}
                        <div>
                            <label className="block text-sm font-medium text-gray-700 mb-2">Festival Banner</label>
                            <div className="flex items-center justify-center w-full">
                                <label className="flex flex-col items-center justify-center w-full h-64 border-2 border-gray-300 border-dashed rounded-lg cursor-pointer bg-gray-50 hover:bg-gray-100 transition-colors">
                                    {currentFestival.image ? (
                                        <img src={currentFestival.image} alt="Preview" className="w-full h-full object-cover rounded-lg" />
                                    ) : (
                                        <div className="flex flex-col items-center justify-center pt-5 pb-6">
                                            <Upload className="w-8 h-8 mb-4 text-gray-500" />
                                            <p className="mb-2 text-sm text-gray-500"><span className="font-semibold">Click to upload</span> or drag and drop</p>
                                    ...
                                    <input type="file" className="hidden" onChange={(e) => handleImageUpload(e, "Festival", activeFestivalTab)} accept="image/*" />
                                </label>
                            </div>
                        </div>
                        ...
                        <div>
                            ...
                            <div className="relative">
                                ...
                                <input
                                    ...
                                    onChange={(e) => setFestivalData({
                                        ...festivalData,
                                        [activeFestivalTab]: { ...currentFestival, title: e.target.value }
                                    })}
                                />
                            </div>
                        </div>
                        ...
                        <div>
                            ...
                            <div className="relative">
                                ...
                                <textarea
                                    ...
                                    onChange={(e) => setFestivalData({
                                        ...festivalData,
                                        [activeFestivalTab]: { ...currentFestival, description: e.target.value }
                                    })}
                                />
                            </div>
                        </div>
                ...
                <nav className="-mb-px flex space-x-8" aria-label="Tabs">
                    {[
                        ...
                        >
                            <tab.icon className={`
                                -ml-0.5 mr-2 h-5 w-5
                                ${activeTab === tab.name ? "text-[#891737]" : "text-gray-400 group-hover:text-gray-500"}
                            `} />
                            {tab.name}
                        </button>
                    ))}
