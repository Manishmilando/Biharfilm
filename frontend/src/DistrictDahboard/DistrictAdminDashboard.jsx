...
function DistrictAdminDashboard() {
  ...
  const validateToken = () => {
    ...
    if (currentUser && currentUser.role !== 'district_admin') {
      showNotification('error', 'Access denied. District admin privileges required.');
      return false;
    }
                  ...
                  >
                    <div className="w-10 h-10 bg-[#802d44] rounded-full flex items-center justify-center">
                      <span className="text-white font-bold text-lg uppercase">
                        {currentUser.districtName ? currentUser.districtName.charAt(0) : 'D'}
                      </span>
                    </div>
          ...
          <div className="flex items-center text-sm text-gray-400 mb-4">
            ...
            {currentUser?.districtName && (
              <>
                ...
                <span className="font-medium text-gray-500">{currentUser.districtName} District</span>
              </>
            )}
          </div>
        </div>
            ...
            <div className="p-6">
              ...
              <div className="mb-6 p-4 bg-gray-50 rounded-lg">
                ...
                <p className="text-sm text-gray-600 mt-2">
                  <span className="font-medium">Title:</span> {selectedForm.title}
                </p>
                <p className="text-sm text-gray-600 mt-2">
